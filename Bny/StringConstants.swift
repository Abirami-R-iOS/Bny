...
struct AppStrings {
    ...
    static let Welcome_Title1 = "MAXIMUM VALUE FOR\nYOU EVERY SPEND"
    static let Welcome_Title2 = "BIG BRANDS\nBIG DEALS"
    static let Welcome_Title3 = "WHY SHOP EVERY\nWHER?"
    static let Welcome_SubTitle1 = "YOUR Instore & Online Shopping\nrewarded with\n\nBig Discounts, Rewards\nand Privileges"
    ...
    static let Did_not_receive_OTP = "Didn't get the OTP?"
